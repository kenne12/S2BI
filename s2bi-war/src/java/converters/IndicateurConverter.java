...
@FacesConverter(value = "indicateurConverter")
public class IndicateurConverter implements Converter {

    @EJB
    private IndicateurFacadeLocal ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Indicateur) {
            Indicateur i = (Indicateur) object;
            return getStringKey(i.getIdindicateur());
        } else {

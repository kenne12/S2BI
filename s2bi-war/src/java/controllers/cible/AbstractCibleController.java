 ...
 * @author kenne
 */
public class AbstractCibleController {
    ...
    protected boolean enable_update_btn = false;
    ...
    public List<Uniteorganisation> getUniteorganisations() {
        try {
            uniteorganisations = uniteorganisationFacadeLocal.findAllRange(true);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public List<Ciblerealisation> getCiblerealisations() {
        try {
            ciblerealisations = ciblerealisationFacadeLocal.findAllBase(true);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public boolean isEnable_update_btn() {
        return enable_update_btn;
    }
